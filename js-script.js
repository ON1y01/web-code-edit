...
var fileList = {
    0: {
        id: 0, title: "file1", link: './files/1.py', data: "#1\n" +
    ...
    1: {
        id: 1, title: "file2", link: './files/2.py', data: "#2\n" +
    ...
    2: {
        id: 2, title: "file3", link: './files/3.py', data: "#3\n" +
    ...
    3: {
        id: 3, title: "file4", link: './files/4.py', data: "#4\n" +
    ...
    4: {
        id: 4, title: "file5", link: './files/5.py', data: "#10\n" +
...
for (i in fileList) {
    document.getElementById('menuCont').innerHTML += `<div id="menuFile" class="menu-wrapper" index="` + i + `"><span><i class="fa fa-file" aria-hidden="true"></i></span><p class="menu-title">` + fileList[i].title + `</p>` + `</div>`;
}
...
for (k = 0; k < test.length; k++) {
    ...
    test[k].addEventListener("click", function () {
        var fileIndex = this.getAttribute('index');
        var fileX = fileList[fileIndex].data;
        // console.log(fileX);
